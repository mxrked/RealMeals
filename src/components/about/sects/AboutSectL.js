...
class AboutSectL extends Component {
  constructor(props) {
    super(props);
          ...
          <div className="row about-sect-row">
            <div className="col-lg-4 col-md-4 col-sm-3 col-xs-12 about-sect-side">
              <div className="about-sect-side-cnt">
                <this.createAboutSectBG aboutSectBG="http://basicallyeasy.com/DynamicCDNS/realmeals/index/about/about-bg-l.jpg"></this.createAboutSectBG>
                <this.createAboutSectBG aboutSectBG="http://basicallyeasy.com/DynamicCDNS/realmeals/index/about/about-bg-r.jpg"></this.createAboutSectBG>
              </div>
            </div>
